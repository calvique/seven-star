...
import { MapPin, Phone, Mail, GraduationCap, Award, Users, BookOpen } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm mb-6 max-w-xs">
              Official school information, announcements and resources published by the administration.
            </p>
